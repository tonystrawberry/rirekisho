/** Product brand (display name + assets). */
export const APP_NAME = "rirekisho!";

/**
 * URL-safe slug for GitHub, npm, Vercel, filenames — no `!` (invalid in those systems).
 * Use `APP_NAME` everywhere user-facing.
 */
export const APP_SLUG = "rirekisho";

/** @deprecated Use APP_SLUG */
